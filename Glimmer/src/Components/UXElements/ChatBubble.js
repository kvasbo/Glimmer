...
export default class ChatBubble extends React.Component {
  constructor(props) {
    ...
    this.fromMe = false;
    this.fromMe = (this.props.message.from_id === store.getState().AppStatus.activeUserId);
  ...
  render() {
    const contentStyle = (this.fromMe) ? htmlViewStylesMe : htmlViewStylesThem;
    const contStyle = (this.fromMe) ? pageStyles.containerMe : pageStyles.containerThem;
    const fromStyle = (this.fromMe) ? pageStyles.boxFromMe : pageStyles.boxFromOther;
    const textStyle = (this.fromMe) ? pageStyles.textFromMe : pageStyles.textFromThem;
