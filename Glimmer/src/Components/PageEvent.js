...
import Event from "./UXElements/Event";
...
class PageEvent extends React.Component {
    ...
    findLastPageOfComments() {
        ...
        let cCount = parseInt(this.props.event.comment_count);
    ...
    getComments() {
        ...
        for (let i = 0; i < tmpPosts.length; i++) {
            ...
            let byStarter = false;
            if (tmpPosts[i].creator_id === this.props.event.creator_id) byStarter = true;
            ...
            <View style={pageStyles.container}>
                ...
                <View style={{flex: 1}}>
                    ...
                    <ScrollView ref={component => this.scrollbar = component} style={{flex: 1}}>
                        ...
                        <Event data={this.props.event} navigator={this.props.navigator} metaData={false}
                                         cut={false}/>
